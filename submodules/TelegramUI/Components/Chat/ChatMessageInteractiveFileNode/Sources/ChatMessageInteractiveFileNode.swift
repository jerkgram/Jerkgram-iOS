...
public final class ChatMessageInteractiveFileNode: ASDisplayNode {
    ...
    private func transcribe() {
        ...
        // MARK: GhostBase v1.1A TRANSCRIPTION1 request without local Premium gate
        ...
        if shouldBeginTranscription {
            if self.transcribeDisposable == nil {
                ...
                // MARK: GhostBase v1.1B TRANSCRIPTION2 local-first voice
                if true {
                    ...
                    |> deliverOnMainQueue).startStrict(next: { [weak self] result in
                        ...
                        if let result = result {
                            ...
                            Logger.shared.log("jerkgram.Transcription2", "local voice transcription unavailable or media not downloaded")
            ...
            return (CGFloat.greatestFiniteMagnitude, { constrainedSize in
                ...
                for attribute in arguments.message.attributes {
                    if let attribute = attribute as? ConsumableContentMessageAttribute {
                        // MARK: Jerkgram v1.2P BUILD127_NATIVE_ONETIME_VOICE_STATUS1
