...
struct GhostBaseProfileMetricsSettings {
    ...
    static func load() -> GhostBaseProfileMetricsSettings {
        ...
        return GhostBaseProfileMetricsSettings(
            enabled: defaults.object(forKey: "jerkgram.Profile.Enabled") as? Bool ?? true,
            showIds: defaults.object(forKey: "jerkgram.Profile.ShowIds") as? Bool ?? true,
            showDCs: defaults.object(forKey: "jerkgram.Profile.ShowDCs") as? Bool ?? true,
            showRegistration: defaults.object(forKey: "jerkgram.Profile.ShowRegistration") as? Bool ?? true,
            hideOwnPhone: defaults.object(forKey: "jerkgram.Appearance.HideOwnPhone") as? Bool ?? false
        )
    }
}
...
private enum GhostBaseProfileAuxiliaryStoreV11G {
    static let queue = DispatchQueue(
        label: "jerkgram.ProfileAuxiliaryStore.V11G",
        qos: .utility
    )
...
func infoItems(
    ...
    // MARK: GhostBase v1.1H PROFILEMETRICS2
    ...
    // MARK: Jerkgram v1.2L BUILD123_REMOVE_PRIVATE_LINK_PROBE1
