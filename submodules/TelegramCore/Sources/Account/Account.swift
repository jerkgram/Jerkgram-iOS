...
private func ghostBaseBotSafeModeEnabled(_ peerId: PeerId) -> Bool {
    return UserDefaults.standard.bool(
        forKey: "jerkgram.BotAccount.\(peerId.toInt64())"
    )
}
...
private func ghostBaseBotSafeRecord(
    ...
    UserDefaults.standard.set(value, forKey: "jerkgram.BotSafe.LastEvent")
    UserDefaults.standard.set(
        value,
        forKey: "jerkgram.BotSafe.LastEvent.\(peerId.toInt64())"
    )
